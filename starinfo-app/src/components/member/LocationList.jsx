...
const LocationList = ({
                          locations, descriptions, favoriteLocationId, // 즐겨찾기 ID를 받아옴
                          onUpdateFavorite, onDescriptionChange, onSaveDescription, onDelete, onEdit
                      }) => {
    ...
    return (<>
        {locations.map((location) => {
            ...
            return (<div key={location.id} className="location-item">
                <p>위도: {location.latitude}, 경도: {location.longitude}</p>
                {/* 즐겨찾기 여부 표시 */}
                <span style={{color: isFavorite ? 'gold' : 'gray', fontWeight: 'bold', fontSize: '24px'}}>
                    {isFavorite ? '★' : '☆'}
                </span>
                ...
                <div className="description-input">
                    <input
                        ...
                        onChange={(e) => onDescriptionChange(location.id, e.target.value)}
                    />
                ...
                <button
                    ...
                    style={{
                        color: "red", marginTop: "10px", fontWeight: isFavorite ? "bold" : "normal", // 즐겨찾기 위치는 강조
                    }}
                >
                    위치 삭제
                </button>
