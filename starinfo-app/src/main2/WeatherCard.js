...
function WeatherCard({ place, time, date, temperature }) {
    return (
        <div className="card">
            <div className="card__info">
                <p className="card__info__place">{place}</p>
                <p className="card__info__time">{time}</p>
                <p className="card__info__date">{date}</p>
            </div>
            <div className="card__weather">
                ...
                <p className="card__weather__temp">{temperature}° C</p>
            </div>
        </div>
    );
}
